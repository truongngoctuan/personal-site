...
import ViewDisplayOptions from "../../components/ViewDisplayOptions";
...
type GameItem = {
  ...
  parentPlatforms: { id: number; name: string }[];
...
type GameTypeProps = {
  ...
  nextPage?: number;
  handleFetchMore: (data: any) => void;
}

const GameList: React.FC<GameTypeProps> = ({ gameResults, nextPage, loading, handleFetchMore }: GameTypeProps) => {
  ...
  // const { data, loading, fetchMore } = useQuery<GamesQueryResponse>(
  //   GET_GAMES,
  //   queryParams
  // );
